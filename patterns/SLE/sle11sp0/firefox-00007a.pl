...
# Title:       Firefox 3 Security Advisory SUSE-SA:2009:063
# Description: Firefox 3 was updated to fix remote code execution issues, CVSS v2 Base Score: 9.3
...
@PATTERN_RESULTS = (
	...
	"META_LINK_Security=http://www.novell.com/linux/security/advisories/2009_63_firefox.html"
);
