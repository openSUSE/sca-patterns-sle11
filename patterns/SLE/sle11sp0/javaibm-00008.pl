...
# Title:       IBM Java 1.6 Security Advisory SUSE-SA:2009:036
# Description: IBM Java 1.6 was updated to fix remote code execution security issues, Severity 8 of 10.
...
@PATTERN_RESULTS = (
	...
	"META_LINK_Security=http://www.novell.com/linux/security/advisories/2009_36_java.html"
);
...
SDP::Core::processOptions();
	...
	if ( SDP::SUSE::compareKernel(SLE11GA) >= 0 && SDP::SUSE::compareKernel(SLE11SP1) < 0 ) {
		...
		@PKGS_TO_CHECK       = qw(java-1_6_0-ibm java-1_6_0-ibm-alsa java-1_6_0-ibm-alsa-x86 java-1_6_0-ibm-devel java-1_6_0-ibm-fonts java-1_6_0-ibm-jdbc java-1_6_0-ibm-plugin java-1_6_0-ibm-x86);
		$FIXED_VERSION       = '1.6.0-124.7.1';
