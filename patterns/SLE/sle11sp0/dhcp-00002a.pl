...
# Title:       DHCP Client Security Advisory SUSE-SA:2009:037
# Description: DHCP Client was updated to fix remote code execution security issues, Severity 8 of 10.
...
@PATTERN_RESULTS = (
	...
	PROPERTY_NAME_COMPONENT."=DHCP",
	PROPERTY_NAME_PATTERN_ID."=$PATTERN_ID",
	PROPERTY_NAME_PRIMARY_LINK."=META_LINK_Security",
	PROPERTY_NAME_OVERALL."=$GSTATUS",
	PROPERTY_NAME_OVERALL_INFO."=None",
	"META_LINK_Security=http://www.novell.com/linux/security/advisories/2009_37_dhclient.html"
);
...
SDP::Core::processOptions();
	...
	if  ( SDP::SUSE::compareKernel(SLE11GA) >= 0 && SDP::SUSE::compareKernel(SLE11SP1) < 0 ) {
		...
		@PKGS_TO_CHECK       = qw(dhcp-client dhcp-debuginfo dhcp-debugsource);
		$FIXED_VERSION       = '3.1.1-7.13.1';
		...
		SDP::Core::printDebug('DISTRIBUTION', 'SLE10SP2');
		@PKGS_TO_CHECK       = qw(dhcp-client);
		$FIXED_VERSION       = '3.0.1rc13-28.26';
		SDP::Core::printDebug('ARGS', "$CHECKING, $ADVISORY, $TYPE, $#PKGS_TO_CHECK, $FIXED_VERSION");
		SDP::SUSE::securitySeverityPackageCheck($CHECKING, $ADVISORY, $TYPE, \@PKGS_TO_CHECK, $FIXED_VERSION);
	} else {
