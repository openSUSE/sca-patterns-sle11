...
# Title:       Acrobat Reader Security Advisory SUSE-SA:2010:058
...
@PATTERN_RESULTS = (
	...
	"META_LINK_Security=http://www.novell.com/linux/security/advisories/2010_58_acroread.html"
);
