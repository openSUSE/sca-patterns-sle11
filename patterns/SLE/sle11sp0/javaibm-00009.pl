...
# Title:       IBM Java 1.6 Security Advisory SUSE-SA:2009:053
...
@PATTERN_RESULTS = (
	...
	"META_LINK_Security=http://www.novell.com/linux/security/advisories/2009_53_ibmjava.html"
);
