...
# Title:       Sun Java 1.6 Security Advisory SUSE-SA:2009:043
# Description: Sun Java 1.6 was updated to fix remote code execution security issues, Severity 8 of 10.
...
@PATTERN_RESULTS = (
	...
	"META_LINK_Security=http://www.novell.com/linux/security/advisories/2009_43_sunjava.html"
);
...
SDP::Core::processOptions();
	...
	if  ( SDP::SUSE::compareKernel(SLE11GA) >= 0 && SDP::SUSE::compareKernel(SLE11SP1) < 0) {
		...
		@PKGS_TO_CHECK       = qw(java-1_6_0-sun java-1_6_0-sun-alsa java-1_6_0-sun-debuginfo java-1_6_0-sun-demo java-1_6_0-sun-jdbc java-1_6_0-sun-plugin java-1_6_0-sun-src);
		$FIXED_VERSION       = '1.6.0.u15-0.1.1';
