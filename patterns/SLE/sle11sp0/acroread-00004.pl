...
# Title:       Acrobat Reader Security Advisory SUSE-SA:2010:008
...
@PATTERN_RESULTS = (
	...
	"META_LINK_Security=http://www.novell.com/linux/security/advisories/2010_08_acroread.html"
);
