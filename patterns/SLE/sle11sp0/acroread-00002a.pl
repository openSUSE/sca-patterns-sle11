...
# Title:       Acrobat Reader Security Advisory SUSE-SA:2009:035
...
@PATTERN_RESULTS = (
	...
	"META_LINK_Security=http://www.novell.com/linux/security/advisories/2009_35_acroread.html"
);
