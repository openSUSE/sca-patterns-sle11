...
# Title:       Flash Player Security Advisory SUSE-SA:2010:055
...
@PATTERN_RESULTS = (
	...
	"META_LINK_Security=http://www.novell.com/linux/security/advisories/2010_55_flash.html"
);
...
SDP::Core::processOptions();
	...
	if  ( SDP::SUSE::compareKernel(SLE11GA) >= 0 && SDP::SUSE::compareKernel(SLE11SP2) < 0 ) {
		...
		$FIXED_VERSION       = '10.1.102.64-0.1.1';
