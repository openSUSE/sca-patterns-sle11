...
# Title:       Firefox 3 Security Advisory SUSE-SA:2009:039
...
@PATTERN_RESULTS = (
	...
	"META_LINK_Security=http://www.novell.com/linux/security/advisories/2009_39_firefox.html"
);
