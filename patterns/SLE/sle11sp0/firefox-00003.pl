...
# Title:       Firefox 3 Security Advisory SUSE-SA:2009:034
...
@PATTERN_RESULTS = (
	...
	"META_LINK_Security=http://www.novell.com/linux/security/advisories/2009_34_firefox.html"
);
...
SDP::Core::processOptions();
	...
	if  ( SDP::SUSE::compareKernel(SLE11GA) >= 0 && SDP::SUSE::compareKernel(SLE11SP1) < 0 ) {
		...
		@PKGS_TO_CHECK       = qw(MozillaFirefox MozillaFirefox-translations MozillaFirefox-debuginfo MozillaFirefox-debugsource);
		$FIXED_VERSION       = '3.0.11-0.1.1';
