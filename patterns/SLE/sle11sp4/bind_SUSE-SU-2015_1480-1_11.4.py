#!/usr/bin/python3
#
# Title:       Important Security Announcement for bind SUSE-SU-2015:1480-1
...
OTHER_LINKS = "META_LINK_Security=http://lists.opensuse.org/opensuse-security-announce/2015-09/msg00005.html"
...
if ( SERVER['DistroVersion'] == 11):
	if ( SERVER['DistroPatchLevel'] == 4 ):
		PACKAGES = {
			...
			'bind-debuginfo': '9.9.6P1-0.15.1',
			'bind-debugsource': '9.9.6P1-0.15.1',
