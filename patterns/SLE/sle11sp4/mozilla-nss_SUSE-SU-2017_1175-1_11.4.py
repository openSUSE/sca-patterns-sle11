...
if ( SERVER['DistroVersion'] == 11):
	if ( SERVER['DistroPatchLevel'] == 4 ):
		PACKAGES = {
			...
			'MozillaFirefox-debuginfo': '45.9.0esr-71.2',
			'MozillaFirefox-debugsource': '45.9.0esr-71.2',
			...
			'mozilla-nspr-debuginfo': '4.13.1-32.1',
			'mozilla-nspr-debuginfo-32bit': '4.13.1-32.1',
			'mozilla-nspr-debuginfo-x86': '4.13.1-32.1',
			'mozilla-nspr-debugsource': '4.13.1-32.1',
			'mozilla-nspr-devel': '4.13.1-32.1',
			'mozilla-nspr-x86': '4.13.1-32.1',
			'mozilla-nss': '3.29.5-46.1',
			'mozilla-nss-32bit': '3.29.5-46.1',
			'mozilla-nss-debuginfo': '3.29.5-46.1',
			'mozilla-nss-debugsource': '3.29.5-46.1',
