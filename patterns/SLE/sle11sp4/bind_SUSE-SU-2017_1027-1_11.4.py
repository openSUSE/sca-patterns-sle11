#!/usr/bin/python
#
# Title:       Important Security Announcement for bind SUSE-SU-2017:1027-1
...
OTHER_LINKS = "META_LINK_Security=http://lists.opensuse.org/opensuse-security-announce/2017-04/msg00018.html"
...
if ( SERVER['DistroVersion'] == 11):
	if ( SERVER['DistroPatchLevel'] == 4 ):
		PACKAGES = {
			...
			'bind-debuginfo': '9.9.6P1-0.47.1',
			'bind-debugsource': '9.9.6P1-0.47.1',
