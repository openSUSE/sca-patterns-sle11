#!/usr/bin/python
#
# Title:       Important Security Announcement for xen SUSE-SU-2015:1299-1
...
OTHER_LINKS = "META_LINK_Security=http://lists.opensuse.org/opensuse-security-announce/2015-07/msg00041.html"
...
if ( SERVER['DistroVersion'] == 11):
	if ( SERVER['DistroPatchLevel'] == 4 ):
		PACKAGES = {
			'xen': '4.4.2_10-5.1',
			'xen-debuginfo': '4.4.2_10-5.1',
			'xen-debugsource': '4.4.2_10-5.1',
