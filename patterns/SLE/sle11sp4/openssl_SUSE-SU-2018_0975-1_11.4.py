#!/usr/bin/python
#
# Title:       Important Security Announcement for openssl SUSE-SU-2018:0975-1
...
OTHER_LINKS = "META_LINK_Security=https://lists.opensuse.org/opensuse-security-announce/2018-04/msg00013.html"
...
if ( SERVER['DistroVersion'] == 11):
	if ( SERVER['DistroPatchLevel'] == 4 ):
		PACKAGES = {
			...
			'openssl-debuginfo': '0.9.8j-0.106.9.1',
			'openssl-debugsource': '0.9.8j-0.106.9.1',
