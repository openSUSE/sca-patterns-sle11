...
# Title:       Java SA SUSE-SU-2013:0328-1
# Description: Contains three fixes
...
@PATTERN_RESULTS = (
	...
	"META_LINK_Security=http://lists.opensuse.org/opensuse-security-announce/2013-02/msg00020.html"
);
