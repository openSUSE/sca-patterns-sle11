...
# Title:       Kernel SA Important SUSE-SU-2014:0837-1
...
"META_LINK_Security=http://lists.opensuse.org/opensuse-security-announce/2014-06/msg00025.html",
);
...
my $TAG = 'SUSE-SU-2014:0837-1';
my %PACKAGES = ();
if ( SDP::SUSE::compareKernel(SLE11SP2) >= 0 && SDP::SUSE::compareKernel(SLE11SP3) < 0 ) {
	%PACKAGES = (
		'ext4-writeable-kmp-default-0_3.0.101_0.7.21' => '0.14.103',
		'ext4-writeable-kmp-pae-0_3.0.101_0.7.21' => '0.14.103',
		'ext4-writeable-kmp-trace-0_3.0.101_0.7.21' => '0.14.103',
		'ext4-writeable-kmp-xen-0_3.0.101_0.7.21' => '0.14.103',
		'kernel-default' => '3.0.101-0.7.21.1',
		'kernel-default-base' => '3.0.101-0.7.21.1',
		'kernel-default-devel' => '3.0.101-0.7.21.1',
		'kernel-default-extra' => '3.0.101-0.7.21.1',
		'kernel-ec2' => '3.0.101-0.7.21.1',
		'kernel-ec2-base' => '3.0.101-0.7.21.1',
		'kernel-ec2-devel' => '3.0.101-0.7.21.1',
		'kernel-pae-extra' => '3.0.101-0.7.21.1',
		...
		'kernel-xen-extra' => '3.0.101-0.7.21.1',
