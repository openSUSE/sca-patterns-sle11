...
# Title:       Flash Player SA SUSE-SU-2013:0373-1
...
@PATTERN_RESULTS = (
	...
	"META_LINK_Security=http://lists.opensuse.org/opensuse-security-announce/2013-02/msg00035.html"
);
