...
# Title:       IBM Java 1.7.0 SA SUSE-SU-2013:0701-1
...
@PATTERN_RESULTS = (
	...
	"META_LINK_Security=http://lists.opensuse.org/opensuse-security-announce/2013-04/msg00020.html"
);
...
SDP::Core::processOptions();
	...
	if ( SDP::SUSE::compareKernel(SLE11SP2) >= 0 && SDP::SUSE::compareKernel(SLE11SP3) < 0 ) {
		%PACKAGES = (
			...
			'java-1_7_0-ibm-devel' => '1.7.0_sr4.1-0.5.1',
