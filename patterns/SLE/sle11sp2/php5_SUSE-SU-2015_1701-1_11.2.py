#!/usr/bin/python
#
# Title:       Important Security Announcement for php5 SUSE-SU-2015:1701-1
...
OTHER_LINKS = "META_LINK_Security=http://lists.opensuse.org/opensuse-security-announce/2015-10/msg00006.html"
...
if ( SERVER['DistroVersion'] == 11):
	if ( SERVER['DistroPatchLevel'] == 2 ):
		PACKAGES = {
			...
			'php5-debuginfo': '5.2.14-0.7.30.72.1',
			'php5-debugsource': '5.2.14-0.7.30.72.1',
