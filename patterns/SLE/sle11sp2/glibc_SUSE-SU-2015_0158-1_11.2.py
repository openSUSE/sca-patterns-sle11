...
if ( SERVER['DistroVersion'] == 11):
	if ( SERVER['DistroPatchLevel'] == 2 ):
		PACKAGES = {
			'glibc': '2.11.3-17.45.55.5',
			'glibc-32bit': '2.11.3-17.45.55.5',
			'glibc-devel': '2.11.3-17.45.55.5',
			'glibc-devel-32bit': '2.11.3-17.45.55.5',
			'glibc-html': '2.11.3-17.45.55.5',
			'glibc-i18ndata': '2.11.3-17.45.55.5',
			'glibc-info': '2.11.3-17.45.55.5',
			'glibc-locale': '2.11.3-17.45.55.5',
			'glibc-locale-32bit': '2.11.3-17.45.55.5',
			'glibc-profile': '2.11.3-17.45.55.5',
			'glibc-profile-32bit': '2.11.3-17.45.55.5',
