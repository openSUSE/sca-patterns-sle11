...
# Title:       Firefox SA Important SUSE-SU-2014:0824-3
...
"META_LINK_Security=http://lists.opensuse.org/opensuse-security-announce/2014-06/msg00027.html",
);
...
if ( SDP::SUSE::compareKernel(SLE11SP2) >= 0 && SDP::SUSE::compareKernel(SLE11SP3) < 0 ) {
	%PACKAGES = (
		...
		'mozilla-nss-devel' => '3.16.1-0.3.1',
