...
# Title:       Firefox SA SUSE-SU-2012:1426-1
# Description: Solves four vulnerabilities
...
@PATTERN_RESULTS = (
	...
	"META_LINK_Security=http://lists.opensuse.org/opensuse-security-announce/2012-10/msg00025.html"
);
