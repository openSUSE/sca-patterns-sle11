...
# Title:       IBM Java 1.6 Security Advisory SUSE-SA:2010:026
...
@PATTERN_RESULTS = (
	...
	"META_LINK_Security=http://www.novell.com/linux/security/advisories/2010_26_ibmjava.html"
);
...
SDP::Core::processOptions();
	...
	if ( SDP::SUSE::compareKernel(SLE11SP1) >= 0 && SDP::SUSE::compareKernel(SLE11SP2) < 0 ) {
		@PKGS_TO_CHECK = qw(java-1_6_0-ibm java-1_6_0-ibm-alsa java-1_6_0-ibm-fonts java-1_6_0-ibm-jdbc java-1_6_0-ibm-plugin);
		$FIXED_VERSION = '1.6.0_sr8.0-0.7.1';
		...
		$FIXED_VERSION = '1.6.0_sr8.0-0.1.2';
		SDP::SUSE::securitySeverityPackageCheck($CHECKING, $SEVERITY, $TYPE, \@PKGS_TO_CHECK, $FIXED_VERSION);
	} else {
