...
if ( SERVER['DistroVersion'] == 11):
	if ( SERVER['DistroPatchLevel'] == 1 ):
		PACKAGES = {
			'glibc': '2.11.1-0.60.1',
			'glibc-32bit': '2.11.1-0.60.1',
			'glibc-devel': '2.11.1-0.60.1',
			'glibc-devel-32bit': '2.11.1-0.60.1',
			'glibc-html': '2.11.1-0.60.1',
			'glibc-i18ndata': '2.11.1-0.60.1',
			'glibc-info': '2.11.1-0.60.1',
			'glibc-locale': '2.11.1-0.60.1',
			'glibc-locale-32bit': '2.11.1-0.60.1',
			'glibc-profile': '2.11.1-0.60.1',
			'glibc-profile-32bit': '2.11.1-0.60.1',
			'nscd': '2.11.1-0.60.1',
		}
