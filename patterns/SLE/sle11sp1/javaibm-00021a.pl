...
# Title:       IBM Java 1.4 Security Advisory SUSE-SA:2011:036
# Description: IBM Java 1.4 was updated to fix remote code execution security issues, CVSS v2 Base Score: 7.5
...
@PATTERN_RESULTS = (
	...
	"META_LINK_Security=http://www.suse.com/support/security/advisories/2011_36_ibmjava.html"
);
...
SDP::Core::processOptions();
	...
	if ( SDP::SUSE::compareKernel(SLE11SP1) >= 0 && SDP::SUSE::compareKernel(SLE11SP2) < 0 ) {
		...
		$FIXED_VERSION = '1.4.2_sr13.10-0.4.1';
