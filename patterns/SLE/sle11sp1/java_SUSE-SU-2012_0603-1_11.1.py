#!/usr/bin/python3
#
# Title:       Important Security Announcement for Java SUSE-SU-2012:0603-1
...
OTHER_LINKS = "META_LINK_Security=http://lists.opensuse.org/opensuse-security-announce/2012-05/msg00010.html"
...
if ( SERVER['DistroVersion'] == 11):
	if ( SERVER['DistroPatchLevel'] == 1 ):
		PACKAGES = {
			...
			'java-1_6_0-ibm-devel': '1.6.0_sr10.1-0.3.1',
