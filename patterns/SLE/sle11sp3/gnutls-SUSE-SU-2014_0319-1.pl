...
# Title:       GnuTLS SA Critical SUSE-SU-2014:0319-1
# Description: solves two vulnerabilities
...
"META_LINK_Security=http://lists.opensuse.org/opensuse-security-announce/2014-03/msg00000.html",
);
