...
OTHER_LINKS = "META_LINK_Security=http://lists.opensuse.org/opensuse-security-announce/2015-01/msg00036.html"
...
if ( SERVER['DistroVersion'] == 11):
	if ( SERVER['DistroPatchLevel'] == 3 ):
		PACKAGES = {
			'MozillaFirefox': '31.4.0esr-0.8.7',
			'MozillaFirefox-devel': '31.4.0esr-0.8.7',
			'MozillaFirefox-translations': '31.4.0esr-0.8.7',
