...
OTHER_LINKS = "META_LINK_Security=http://lists.opensuse.org/opensuse-security-announce/2015-07/msg00035.html"
...
if ( SERVER['DistroVersion'] == 11):
	if ( SERVER['DistroPatchLevel'] == 3 ):
		PACKAGES = {
			...
			'MozillaFirefox-debuginfo': '31.8.0esr-0.10.1',
			'MozillaFirefox-debugsource': '31.8.0esr-0.10.1',
			'MozillaFirefox-devel': '31.8.0esr-0.10.1',
			...
			'mozilla-nspr-debuginfo': '4.10.8-0.5.1',
			'mozilla-nspr-debuginfo-32bit': '4.10.8-0.5.1',
			'mozilla-nspr-debuginfo-x86': '4.10.8-0.5.1',
			'mozilla-nspr-debugsource': '4.10.8-0.5.1',
			'mozilla-nspr-devel': '4.10.8-0.5.1',
			'mozilla-nspr-x86': '4.10.8-0.5.1',
			'mozilla-nss': '3.19.2_CKBI_1.98-0.10.1',
			'mozilla-nss-32bit': '3.19.2_CKBI_1.98-0.10.1',
			'mozilla-nss-debuginfo': '3.19.2_CKBI_1.98-0.10.1',
			'mozilla-nss-debugsource': '3.19.2_CKBI_1.98-0.10.1',
			'mozilla-nss-devel': '3.19.2_CKBI_1.98-0.10.1',
