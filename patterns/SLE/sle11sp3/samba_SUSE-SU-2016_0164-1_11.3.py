#!/usr/bin/python
#
# Title:       Important Security Announcement for samba SUSE-SU-2016:0164-1
...
OTHER_LINKS = "META_LINK_Security=http://lists.opensuse.org/opensuse-security-announce/2016-01/msg00017.html"
...
if ( SERVER['DistroVersion'] == 11):
	if ( SERVER['DistroPatchLevel'] == 3 ):
		PACKAGES = {
			...
			'samba-debuginfo': '3.6.3-64.1',
			'samba-debuginfo-32bit': '3.6.3-64.1',
			'samba-debuginfo-x86': '3.6.3-64.1',
			'samba-debugsource': '3.6.3-64.1',
