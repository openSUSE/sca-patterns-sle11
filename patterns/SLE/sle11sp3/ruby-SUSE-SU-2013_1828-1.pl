...
# Title:       Ruby SA Critical SUSE-SU-2013:1828-1
...
"META_LINK_Security=http://lists.opensuse.org/opensuse-security-announce/2013-12/msg00001.html",
);
...
my $NAME = 'Ruby';
my $MAIN_PACKAGE = 'ruby';
my $SEVERITY = 'Important';
my $TAG = 'SUSE-SU-2013:1828-1';
my %PACKAGES = ();
