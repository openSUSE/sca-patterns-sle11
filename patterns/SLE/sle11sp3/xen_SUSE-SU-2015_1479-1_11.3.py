#!/usr/bin/python3
#
# Title:       Important Security Announcement for xen SUSE-SU-2015:1479-1
...
OTHER_LINKS = "META_LINK_Security=http://lists.opensuse.org/opensuse-security-announce/2015-09/msg00002.html"
...
if ( SERVER['DistroVersion'] == 11):
	if ( SERVER['DistroPatchLevel'] == 3 ):
		PACKAGES = {
			'xen': '4.2.5_12-15.1',
			'xen-debuginfo': '4.2.5_12-15.1',
			'xen-debugsource': '4.2.5_12-15.1',
